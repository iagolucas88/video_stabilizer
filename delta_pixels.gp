...
set xrange [ 0.00000 : 5160.00 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
set ylabel "Delta Pixels" 
...
GNUTERM = "x11"
plot "data_transform.txt" u 1:2 w l title "Horizontal (X)" ls 1 lw 1, "data_transform.txt" u 1:3 w l title "Vertical (Y)" ls 7 lw 1
#    EOF
